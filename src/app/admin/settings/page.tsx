...
const defaultSettings: SystemSettings = {
  ...
  notificationTemplates: {
    lowRisk: 'Se ha detectado un nivel de riesgo bajo. Se recomienda seguimiento.',
    mediumRisk: 'Alerta de riesgo medio detectada. Requiere intervención programada.',
    highRisk: 'ALERTA CRÍTICA: Riesgo alto detectado. Requiere intervención inmediata.'
  }
}
...
export default function AdminSettingsPage() {
  ...
  const [saveAlert, setSaveAlert] = useState<{ show: boolean; type: 'success' | 'error'; message: string }>({
    show: false,
    type: 'success',
    message: ''
  })
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      setTimeout(() => setSaveAlert(prev => ({ ...prev, show: false })), 5000)
    } catch (error) {
      setSaveAlert({ 
        show: true, 
        type: 'error', 
      ...
      reader.onload = (e) => {
        try {
          ...
          setSaveAlert({ 
            show: true, 
            type: 'error', 
            message: 'Error al importar la configuración. Verifica que el archivo sea válido.' 
          })
          setTimeout(() => setSaveAlert(prev => ({ ...prev, show: false })), 5000)
        }
      }
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Configuración del Sistema</h1>
        <p className="text-gray-600">
          Gestiona la configuración avanzada de la plataforma de detección de riesgo suicida
        </p>
      </div>
          ...
          <div className="grid gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configura los umbrales de riesgo para la activación de alertas automáticas
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">Riesgo Bajo</label>
                    <Input
                      type="number"
                      min="0"
                      max="1"
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">Valor entre 0.0 y 1.0</p>
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium mb-2">Riesgo Medio</label>
                    <Input
                      type="number"
                      min="0"
                      max="1"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Riesgo Alto</label>
                    <Input
                      type="number"
                      min="0"
                      max="1"
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      className="rounded border-gray-300"
                    />
                    <span className="text-sm">Enviar notificaciones por email</span>
                  </label>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Parámetros del modelo de machine learning para detección de riesgo
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">                  <div>
                    <label className="block text-sm font-medium mb-2">Versión del Modelo</label>
                    <Select
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Frecuencia de Reentrenamiento (días)</label>
                    <Input
                      type="number"
                      min="1"
                      max="30"
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-medium text-blue-900 mb-2">Estado del Modelo</h4>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <span className="text-blue-600">Último entrenamiento:</span>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">Retención de Datos (días)</label>
                    <Input
                      type="number"
                      min="30"
                      max="2555"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Frecuencia de Respaldo (horas)</label>
                    <Input
                      type="number"
                      min="1"
                      max="168"
                  ...
                  <div className="flex items-center justify-center">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-gray-300"
                      />
                      <span className="text-sm">Activar anonimización automática</span>
                    </label>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h4 className="font-medium text-yellow-800">Consideraciones de Privacidad</h4>
                      <p className="text-sm text-yellow-700 mt-1">
                        Los datos de estudiantes son sensibles. Asegúrate de cumplir con las regulaciones 
                        de protección de datos locales e institucionales. La anonimización puede afectar 
                        la precisión del modelo ML.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-3">Estadísticas Actuales</h4>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
          ...
          <div className="grid gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Personaliza los mensajes de notificación para cada nivel de riesgo
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium text-red-800">Monitoreo de Seguridad</h4>
                      <p className="text-sm text-red-700 mt-1">
                        Sistema de detección de anomalías y logs de acceso activos.
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Registrar accesos exitosos</span>
                      </label>
                      <label className="flex items-center gap-2">
                        <input type="checkbox" defaultChecked className="rounded" />
                        <span className="text-sm">Registrar intentos fallidos</span>
                      </label>
                      <label className="flex items-center gap-2">
                        <input type="checkbox" defaultChecked className="rounded" />
                        <span className="text-sm">Registrar cambios de configuración</span>
                      </label>
                      <label className="flex items-center gap-2">
                ...
                {showPasswords && (
                  <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                    <h5 className="font-medium text-yellow-800 mb-2">Credenciales del Sistema</h5>
