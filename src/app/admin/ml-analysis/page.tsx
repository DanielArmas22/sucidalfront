...
export default function MLExplainabilityPage() {
  ...
  const regenerateAnalysis = () => {
    ...
    setTimeout(() => {
      ...
      newAnalysis.riskLevel = newAnalysis.riskScore < 0.4 ? 'low' : 
                             newAnalysis.riskScore < 0.7 ? 'medium' : 'high'
  ...
  const exportAnalysis = () => {
    ...
    const exportFileDefaultName = `ml-analysis-${analysis.userId}-${new Date().toISOString().split('T')[0]}.json`
      ...
      <div className="p-6 max-w-6xl mx-auto">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-lg font-medium text-gray-900">Analizando patrones...</p>
    ...
    return (
      <div className="p-6 max-w-6xl mx-auto">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">No se pudo cargar el análisis de ML</p>
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Análisis de Explicabilidad ML</h1>
        <p className="text-gray-600">
          Comprende cómo el modelo de machine learning determina el nivel de riesgo
        </p>
      </div>
      ...
      <div className="mb-6">
        <Alert variant="info">
          ...
          <AlertDescription>
            Este análisis utiliza datos anonimizados y está sujeto a confidencialidad profesional. 
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className={`inline-flex px-3 py-1 rounded-full text-sm font-medium border ${getRiskColor(analysis.riskLevel)}`}>
          ...
          <CardContent>
            <div className="space-y-4">
              {analysis.factors.map((factor, index) => (
                <div key={index} className={`p-4 rounded-lg border ${getFactorColor(factor.type)}`}>
        ...
        {showTechnicalDetails && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Información técnica sobre el modelo de machine learning utilizado
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{analysis.modelVersion}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Datos de entrenamiento:</span>
              ...
              <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h5 className="font-medium text-yellow-800">Limitaciones del Modelo</h5>
                    <p className="text-sm text-yellow-700 mt-1">
                      Este modelo es una herramienta de apoyo y no reemplaza el juicio clínico profesional. 
                      Los resultados deben ser interpretados por personal capacitado y siempre requieren 
                      validación humana antes de tomar decisiones de intervención.
                    </p>
                  </div>
                </div>
              </div>
